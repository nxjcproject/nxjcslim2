<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Yearly.aspx.cs" Inherits="NXJC.UI.Web.FractionalElectricPowerCount.Yearly" %>
...
<body>
	...
	<div class="easyui-panel" style="width:100%;padding:5px;">
        年份：<input id="year" class="easyui-datetimespinner" value="2014" data-options="formatter:yearFormatter,parser:yearParser,selections:[[0,4]]" style="width:80px;" /> 
