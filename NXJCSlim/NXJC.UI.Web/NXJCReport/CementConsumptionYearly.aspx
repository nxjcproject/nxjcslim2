<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CementConsumptionYearly.aspx.cs" Inherits="NXJC.UI.Web.NXJCReport.CementConsumptionYearly" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function loadGridData(myLoadType) {
            ...
            $.ajax({
                type: "POST",
                url: "CementConsumptionYearly.aspx/GetCompanyData",                 //填写后台方法链接
                data: "",//"{id: ''}",
...
<body>
    <table id="gridMain_CellEdit" class="easyui-datagrid" title="" style="width:400px;height:auto">
	</table>
</body>
</html>