<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CementMillProductionLineMonthlyOutput.aspx.cs" Inherits="NXJC.UI.Web.Report.CementMillProductionLineMonthlyOutput" %>
  ...
  <link href="/Scripts/easyui/themes/gray/easyui.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        function loadGridData(myLoadType) {
            ...
            $.ajax({
                type: "POST",
                url: "CementMillProductionLineMonthlyOutput.aspx/GetCompanyData",                 //填写后台方法链接
                data: "",//"{id: ''}",
...
<body>
    <table id="gridMain_CellEdit" class="easyui-datagrid" title="" style="width:710px;height:auto">
	</table>
</body>
</html>
